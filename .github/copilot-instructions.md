...
- Preserve engine namespace isolation under `RecordingStudio::YouTube` unless the task is explicitly about renaming the gem.
- Treat `docs/recording_studio_youtube/` as architectural reference material. For current addon workflow, prefer the top-level README and the dummy app.

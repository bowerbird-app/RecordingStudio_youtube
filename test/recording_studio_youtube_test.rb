...
class RecordingStudioYouTubeTest < Minitest::Test
  ...
  def test_engine_exists
    assert_kind_of Class, ::RecordingStudio::YouTube::Engine
  end

  def test_gemspec_pins_recording_studio_4_2
    gemspec = File.read(File.expand_path("../recording_studio_youtube.gemspec", __dir__))

    assert_includes gemspec, 'spec.add_dependency "recording_studio", "~> 4.2"'
  end

  def test_gemspec_excludes_cursor_config
    spec = Gem::Specification.load(File.expand_path("../recording_studio_youtube.gemspec", __dir__))
  ...
  def test_cursor_environment_is_repo_managed_without_snapshot
    ...
    assert_equal "recording-studio-youtube", json["name"]
  ...
  def test_template_does_not_ship_copied_core_hooks_or_base_service
    ...
    refute File.exist?(File.expand_path("../lib/recording_studio_youtube/services/base_service.rb", __dir__))
  ...
  def test_engine_does_not_ship_a_home_view
    view_path = File.expand_path("../app/views/recording_studio_youtube/home/index.html.erb", __dir__)

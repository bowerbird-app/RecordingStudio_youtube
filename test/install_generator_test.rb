...
class InstallGeneratorTest < Minitest::Test
  ...
  def test_add_tailwind_source_does_not_duplicate_existing_entries
    with_temp_app do |dir|
      ...
      File.write(css_path, <<~CSS)
        ...
        @source "../../../../../../usr/local/bundle/ruby/**/bundler/gems/recording_studio_youtube-*/app/views/**/*.erb";
  ...
  def tailwind_source_lines
    [
      '@source "../../vendor/bundle/**/recording_studio_youtube/app/views/**/*.erb";',
      "@source \"../../../../../../usr/local/bundle/ruby/**/" \
      "bundler/gems/recording_studio_youtube-*/app/views/**/*.erb\";",
      '@source "../../vendor/bundle/**/flatpack/app/components/**/*.{rb,erb}";',
      '@source "../../../../../../usr/local/bundle/ruby/**/bundler/gems/flatpack-*/app/components/**/*.{rb,erb}";'
    ]
  end
